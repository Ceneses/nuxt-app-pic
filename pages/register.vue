    ...
    <div class="grid md:h-screen md:grid-cols-2">
      ...
      <div class="flex flex-col items-center justify-center bg-white">
        ...
        <div class="max-w-lg px-5 py-16 text-center md:px-10 md:py-24 lg:py-32">
          <!-- Title -->
          <h2 class="mb-8 text-3xl font-bold md:mb-12 md:text-5xl">注册</h2>
          <!-- Form -->
          <form class="mx-auto mb-4 max-w-sm pb-4" name="wf-form-password" method="get">
            ...
            <label class="mb-6 flex items-center pb-12 font-medium lg:mb-1">
              ...
              <span class="ml-4 inline-block cursor-pointer text-sm" for="checkbox">I agree with the <a href="#"
                                                                                                        class="font-bold text-[#0b0b1f]">Terms &amp; Conditions</a>
            </span>
            </label>
            <!-- Button -->
            <a href="#"
          ...
          <p class="text-sm text-[#636262]">Already have an account? <a href="#" class="text-sm font-bold text-black">Login
            now</a>
          </p>
        </div>
      </div>
